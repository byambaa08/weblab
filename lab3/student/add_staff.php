	...
	<div id="form">
		<?php
			if(isset($_GET['error']) && $_GET['error']==1)
				echo "<p><font color='#e60000'><center>Ажилтны ID давхцаж байна!</center></font></p>";
			if(isset($_GET['error']) && $_GET['error']==2)
				echo "<p><font color='#e60000'><center>Ажилтны ID дээд талдаа 12 оронтой байна!</center></font></p>";?>
<form action="process.php" method="POST">
			<p>
				<input type="hidden" name="add_staff" value="add_staff">
				<?php echo '<input type="hidden" name="id" value='.$_GET['id'].'>'; ?>
  				<p><div class="input-group-prepend">
					<input type="text" id="staff_id" name="staff_id" placeholder="Ажилтны ID" class="form-control" aria-describedby="basic-addon1" required>
				</div></p>
			...
			<p class = 'text-success'>Ажилд орсон огноо</font></p>
			<p>
  				<div class="input-group-prepend">
					<input type="date" id="user" name="start_date" class="form-control" aria-describedby="basic-addon1" required>
				</div>
			</p>

			<p>
  				<div class="input-group-prepend">
					<input type="text" id="user" name="occu" placeholder="Албан тушаал" class="form-control" aria-describedby="basic-addon1" required>
				</div>
			</p>
			<p>
